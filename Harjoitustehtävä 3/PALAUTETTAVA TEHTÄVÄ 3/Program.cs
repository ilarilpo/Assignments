    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)    // lisätään looppi tietovisan lopuksi
            {
                ...
                string[,] kysymykset = new string[4, 2];
                ...
                kysymykset[2, 1] = "c";
                kysymykset[3, 0] = "Mikä on videopelien jakelualustan Steamin pelatuin peli (a=Team Fortress 2, b=Counter-Strike Global Offensive, c=Dota 2)?";
                kysymykset[3, 1] = "b";
                ...
                Console.WriteLine("Oikeat vastaukset : " + oikeat + " / 4");
